![docker image](https://github.com/ArminFeldhoff/test-nov4/actions/workflows/docker-publish.yml/badge.svg)


# ArminFeldhoff's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of ArminFeldhoff.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/ArminFeldhoff/test-nov4.git
    cd test-nov4
    ```
    ...
    ```sh
    curl-L -o test-nov4.zip "https://github.com/ArminFeldhoff/test-nov4/archive/main.zip"
    unzip test-nov4.zip
    cd test-nov4
    ```
...
your `docker-compose.yaml` with `ghcr.io/arminfeldhoff/test-nov4:main` for the services
...
```sh
docker pull ghcr.io/arminfeldhoff/test-nov4/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/ArminFeldhoff/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/ArminFeldhoff/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/ArminFeldhoff/test-nov4/manifests/main": unauthorized`
